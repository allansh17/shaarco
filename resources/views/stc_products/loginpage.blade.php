                ...
                <div class="form-inner">
                    ...
                    <form>                        
                        <div class="form-group mobile_code">
                            <input type="number" id="mobile_code" class="form-control" name="name">
                        </div>
                        ...
                        <button type="button" class="btn btn-login">تسجيل الدخول <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M400-240 160-480l240-240 56 58-142 142h486v80H314l142 142-56 58Z"></path></svg></button>
                        <div class="Sign_links">
                            <p>ليس لديك حساب؟ <a href="">اشتراك</a></p>
                        </div>
                    </form>
                </div>
            </div>
