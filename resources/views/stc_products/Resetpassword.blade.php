        ...
        <div class="container">
            <div class="form-area">
                <div class="form-inner">
                    ...
                    <p class="mb-5 text-center">الرجاء إدخال كلمة المرور الخاصة بك وتأكيد كلمة المرور</p>
                    <form>                        
                        ...
                        <button type="button" class="btn btn-login">إعادة تعيين كلمة المرور<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M400-240 160-480l240-240 56 58-142 142h486v80H314l142 142-56 58Z"></path></svg></button>
