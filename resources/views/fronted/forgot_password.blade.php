        ...
        <div class="container">
            <div class="form-area">
                <div class="form-inner">
                    <h3 class="mb-0">نسيت كلمة السر؟</h3>
                    <p class="mb-5 text-center">الرجاء إدخال البريد الإلكتروني المستخدم لتسجيل الدخول</p>
                    <form>

                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="بريدك الالكتروني">
                        </div>
                        <button type="button" class="btn btn-login">طلب إعادة تعيين كلمة المرور<svg
                                xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                                fill="#5f6368">
                                <path d="M400-240 160-480l240-240 56 58-142 142h486v80H314l142 142-56 58Z"></path>
                            </svg></button>
                        <div class="Sign_links">
                            <p><a href="{{route('sign_in')}}">العودة إلى تسجيل الدخول</a></p>
                        </div>
                    </form>
                </div>
            </div>
