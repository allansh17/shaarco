       ...
       <div class="card">
          ...
          <div class="card-body">
             <div class="row">
                ...
                <div class="col-sm-3">
                   <div class="d-flex">
                      <button type="button" class="btn btn-primary btn-rounded-20" id="reset_data" style="padding: 9px 14px;">
...
function addItem() {
    $("#addEditForm")[0].reset();
    $('.image-border-shap').css('display', 'none');
...
// Append the <img> tags to their respective containers
                    ...
                    $('#imagePreview1').attr('src', imagePath1);
