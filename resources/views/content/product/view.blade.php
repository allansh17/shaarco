   ...
   <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between mb-4 text-center text-sm-start gap-2">
        <div class="mb-2 mb-sm-0">
          <h4 class="mb-1">
            Customer ID #{{$customer_detail->id}}
          </h4>
          <p class="mb-0">
            {{ $customer_detail->created_at->format('Y-m-d') }}
        </p>
        </div>
        <button type="button" onclick="deleteItem('{{ $customer_detail->id }}')" class="btn btn-label-danger delete-customer">Delete Customer</button>
      </div>
      ...
      <div class="row">
            ...
            <div class="card-body">
              <div class="customer-avatar-section">
                <div class="d-flex align-items-center flex-column">
                  <img class="img-fluid rounded my-3" src={{'/uploads/customer_profile_img/'.$customer_detail->image}} height="110" width="110" alt="User avatar">
                  <div class="customer-info text-center">
                    <h4 class="mb-1">{{$customer_detail->first_name . ' ' .$customer_detail->last_name}}</h4>
                    <small>Customer ID #{{$customer_detail->id}}</small>
                  </div>
                </div>
              </div>
        ...
        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
          ...
          <ul class="nav nav-pills flex-column flex-md-row mb-4">
            <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="pill" data-bs-target="#overview-tab">Overview</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="pill" data-bs-target="#security-tab">Security</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="pill" data-bs-target="#address-tab">Address & Billing</a>
            </li>
            <!-- ... -->
          </ul>
          <!--/ Customer Pills -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="card-info">
                    ...
                    <p class="text-muted mb-0 text-truncate">You have {{$address_count}} saved addresses. Manage them now!</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card mb-4" id="change_pass" id="security-card">
          ...
          <div class="card card-action mb-4" id="address" id="address-card">
                    ...
                    <a class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#ecommerceBillingAddressHome"  aria-expanded="false" aria-controls="headingHome" role="button">
                      <span>
                        <span class="d-flex gap-2 align-items-baseline">
                          @if($address_default->is_default ==1)
                  ...
                  <table class="table">
                     <thead>
                        <tr>
                           ...
                           <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 65px;" aria-label="Order: activate to sort column ascending" aria-sort="descending">Order</th>
                           ...
                           <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 70px;" aria-label="Spent: activate to sort column ascending">Spent</th>
                           <th class="text-md-center sorting_disabled dtr-hidden" rowspan="1" colspan="1" style="width: 0px; display: none;" aria-label="Actions">Actions</th>
                        </tr>
                     </thead>
                     <tbody>   
                        ...
                        <tr class="even">
                           ...
                           <td><span class="text-nowrap"> {{ $order->created_at->format('Y-m-d') }}</span> </td>
                           ...
                           <td class="dtr-hidden" style="display: none;">
                              <div class="text-xxl-center">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">View</a><a href="javascript:;" class="dropdown-item  delete-record">Delete</a></div>
                              </div>
                           </td>
                        </tr>
                        @endforeach
        ...
        <div class="modal-dialog modal-lg modal-simple modal-edit-user">
          <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
              ...
              <form id="addaddressform" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" onsubmit="return false" novalidate="novalidate" method="POST">
               <input type="hidden" name="id" value={{$customer_detail->id}}>
               @csrf
