    ...
    public function handle() {
        ...
        if (count($payroll_exist) > 0) {
            ...
            $attendance = DB::table('attendances as a')
                    ...
                    ->join('employee_general_info as e', 'e.id', '=', DB::raw(' (CASE WHEN ad.relief_employee_id IS NULL THEN ad.employee_id ELSE ad.relief_employee_id END) '))
            ...
            foreach ($attendance as $key => $val) {
                ...
                $empType = DB::table('employee_general_info')
                        ->select('type')
