...
class EmployeePermitNotify extends Command
{
    ...
    public function handle()
    {
        ...
        $employeePermits = EmployeePermit::join('employee_general_info','employee_general_info.id','employee_permits.employee_id')->join('employee_permit_details','employee_permit_details.id','employee_permits.active_permit_id')->select('employee_permits.employee_id','employee_permit_details.expiry_date','employee_general_info.first_name','employee_general_info.last_name','employee_general_info.employee_type')->get();
